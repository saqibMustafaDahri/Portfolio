        ...
        <div className="max-w-7xl mx-auto py-[42px] px-4 md:px-0 flex flex-col md:flex-row items-center gap-10 md:gap-0">
            ...
            <div className="w-full md:w-[40%] flex items-center justify-center md:justify-end">
                <Link href="/contactus">
                    ...
                    <div className="w-[80px] h-[80px] md:w-[120px] md:h-[120px]  flex items-end justify-center ">
                        <div className="bg-primary rounded-full w-[80px] h-[80px] md:w-[120px] md:h-[120px] flex flex-col justify-center items-center   "> <ArrowUpRight /> <p className="text-white text-[12px] md:text-[16px] leading-[15px] w-[56px] text-center pt-1">Contact Now</p></div>
                    </div>
                </Link>
