        ...
        <section className="w-full pt-16 pb-8 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto grid grid-cols-12 items-start px-4 xl:px-0">
                <div className="col-span-12 lg:col-span-11 text-center lg:text-left">
                    <h1 className="text-[40px] sm:text-[64px] md:text-[80px] font-bold text-black leading-[1.1] tracking-tight font-sans">
                        ...
                        <span className="text-primary">Marketing & Creative</span> <br className="hidden md:block" />
                ...
                <div className="col-span-12 lg:col-span-1 flex flex-row lg:flex-col items-center justify-center lg:justify-self-end gap-5 pt-8 lg:pt-4">
                    <div className="hover:opacity-80 transition-opacity w-[42px] h-[42px] bg-black flex items-center justify-center rounded-full border-[#E5E5E5] border-[1.17px]">
                        <Link href="#" >
                            <FaceBook />
                        </Link>
                    </div>
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 mt-16 items-end max-w-7xl mx-auto px-4 xl:px-0">
                ...
                <div className="flex justify-center md:justify-end w-full">
                    <div className="overflow-hidden rounded-sm shadow-sm max-w-[400px] w-full aspect-[4/3] relative">
                        <Image
                            src="/female.png"
