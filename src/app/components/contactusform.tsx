...
export default function ContactUsForm() {
    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between gap-[40px] lg:gap-0">
            <div className="w-full lg:w-auto text-center lg:text-left">
                <h2 className="text-black text-[32px] md:text-[48px] font-bold">
                    General <span className="text-primary">Enquiries.</span>
                </h2>
                <p className="text-[16px] md:text-[20px] text-[#374151]">
            ...
            <div className="flex flex-col gap-[24px] w-full lg:w-[576px]">
                ...
                <div className="flex flex-col md:flex-row gap-[30px]">
                    <div className="w-full">
                        ...
                        />
                        {errors.companyName && <p className="text-red-500 text-[13px] mt-1">{errors.companyName}</p>}
                    </div>
                    <div className="w-full">
                        <p className="text-black text-[18px] font-semibold">Email</p>
                        <input
                ...
                <div>
                    ...
                    />
                    {errors.projectBudget && <p className="text-red-500 text-[13px] mt-1">{errors.projectBudget}</p>}
                </div>
                ...
                <div>
                    ...
                    />
                    {errors.projectDetail && <p className="text-red-500 text-[13px] mt-1">{errors.projectDetail}</p>}
                </div>
