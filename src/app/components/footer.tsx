...
export default function Footer() {
    return (
        <div className="min-h-[526px] h-auto w-full bg-black pt-[48px] md:pt-[96px] pb-[48px] md:pb-0 grid gap-[38px] px-4 lg:px-0">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 md:gap-60">
                <div className="h-auto md:h-[216px] grid gap-[20px] w-full">
