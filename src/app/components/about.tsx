...
export default function About({
    ...
    return (
        <div className="bg-[#242424] min-h-[839px] h-auto pt-[60px] md:pt-[120px] pb-[60px] md:pb-0 relative px-4 lg:px-0">
            <div className="max-w-7xl mx-auto h-auto flex flex-col lg:flex-row gap-[64px] mb-[60px] md:mb-[86.5px]">
                <div className="">
                ...
                <div className="w-full lg:w-[574px] text-center lg:text-left px-0 lg:px-0">
                    ...
                    <h3 className="text-[16px] md:text-[24px] text-white leading-[144%] font-light">
                        {description}
                    </h3>
                </div>
            </div>
